...
public class ModificarGUI extends javax.swing.JFrame {
     ...
     */
        private class WorkerCorreoMod extends SwingWorker<Void, Void> {

       
        @Override
        protected Void doInBackground() throws Exception {
            new BLL.Correos().envioCorreosModif(jLabelEquipo.getText(), 
    ...
    private Manteciones mant;
    private javax.swing.JPanel jp;
    private BLL.Usuarios user;
     private JDialog modalDialog;  
     
    public ModificarGUI(String nombre, javax.swing.JPanel jp, BLL.Usuarios user) {
        
        initComponents();
        
        
        this.jLabelEquipo.setText(nombre);
        this.mant = new Manteciones(jLabelEquipo.getText());
        
        this.jTextArea1.setText(
        mant.buscarModif()
        );
        this.jLabelOT.setText(String.valueOf(mant.getnOt()));
        this.jTextArea1.setEnabled(false);
        this.jLabelFecha.setText(mant.getFecha().toString());
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Modificar Solicitud");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (mant.modificarMant(this.jTextArea2.getText(), 
            ...
            WorkerCorreoMod w = new WorkerCorreoMod();
            w.execute();
